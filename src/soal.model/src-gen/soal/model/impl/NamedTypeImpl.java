 ...
 * </p>
 * <ul>
 * <li>{@link soal.model.impl.NamedTypeImpl#getName <em>Name</em>}</li>
 * <li>{@link soal.model.impl.NamedTypeImpl#getDocumentationLazy
 * <em>Documentation Lazy</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedTypeImpl extends TypeImpl implements NamedType {
	/**
	...
	protected EClass eStaticClass() {
		return SoalModelPackage.Literals.NAMED_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoalModelPackage.NAMED_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetDocumentationLazy(Documentation newDocumentationLazy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SoalModelPackage.NAMED_TYPE__DOCUMENTATION_LAZY, oldDocumentationLazy, newDocumentationLazy);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDocumentationLazy != documentationLazy) {
			...
			if (documentationLazy != null)
				msgs = ((InternalEObject) documentationLazy).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SoalModelPackage.NAMED_TYPE__DOCUMENTATION_LAZY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SoalModelPackage.NAMED_TYPE__DOCUMENTATION_LAZY,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SoalModelPackage.NAMED_TYPE__DOCUMENTATION_LAZY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SoalModelPackage.NAMED_TYPE__NAME:
			return getName();
		case SoalModelPackage.NAMED_TYPE__DOCUMENTATION_LAZY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
			case SoalModelPackage.NAMED_TYPE__NAME:
				return SoalModelPackage.NAMED_ELEMENT__NAME;
			case SoalModelPackage.NAMED_TYPE__DOCUMENTATION_LAZY:
				return SoalModelPackage.NAMED_ELEMENT__DOCUMENTATION_LAZY;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NamedElement.class) {
			...
			case SoalModelPackage.NAMED_ELEMENT__NAME:
				return SoalModelPackage.NAMED_TYPE__NAME;
			case SoalModelPackage.NAMED_ELEMENT__DOCUMENTATION_LAZY:
				return SoalModelPackage.NAMED_TYPE__DOCUMENTATION_LAZY;
			default:
				return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == NamedElement.class) {
			...
			case SoalModelPackage.NAMED_ELEMENT___GET_UNIQUE_NAME:
				return SoalModelPackage.NAMED_TYPE___GET_UNIQUE_NAME;
			case SoalModelPackage.NAMED_ELEMENT___GET_DOCUMENTATION:
				return SoalModelPackage.NAMED_TYPE___GET_DOCUMENTATION;
			case SoalModelPackage.NAMED_ELEMENT___GET_HOVER_DOCUMENTATION:
				return SoalModelPackage.NAMED_TYPE___GET_HOVER_DOCUMENTATION;
			default:
				return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case SoalModelPackage.NAMED_TYPE___GET_UNIQUE_NAME:
			return getUniqueName();
		case SoalModelPackage.NAMED_TYPE___GET_DOCUMENTATION:
			return getDocumentation();
		case SoalModelPackage.NAMED_TYPE___GET_HOVER_DOCUMENTATION:
