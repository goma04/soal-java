...
class EnumImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Enum {
    static {
    ...
    public EnumImpl() {
        this.mSet(metadslx.languages.soal.SoalDescriptor.Enum.EnumLiteralsProperty, new metadslx.core.ModelList<EnumLiteral>(this, metadslx.languages.soal.SoalDescriptor.Enum.EnumLiteralsProperty));
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().Enum(this);
        this.mMakeDefault();
    }
    
    public metadslx.languages.soal.Enum getBaseType() {
        Object result = this.mGet(metadslx.languages.soal.SoalDescriptor.Enum.BaseTypeProperty); 
        if (result != null) return (metadslx.languages.soal.Enum)result;
        else return (metadslx.languages.soal.Enum)null;
    }
    
    public void setBaseType(metadslx.languages.soal.Enum value) {
        this.mSet(metadslx.languages.soal.SoalDescriptor.Enum.BaseTypeProperty, value);
    }
    
    public java.util.List<metadslx.languages.soal.EnumLiteral> getEnumLiterals() {
        Object result = this.mGet(metadslx.languages.soal.SoalDescriptor.Enum.EnumLiteralsProperty); 
        if (result != null) return (java.util.List<metadslx.languages.soal.EnumLiteral>)result;
        else return (java.util.List<metadslx.languages.soal.EnumLiteral>)null;
    }
