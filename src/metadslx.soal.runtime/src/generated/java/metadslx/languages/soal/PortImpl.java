...
class PortImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Port {
    static {
    ...
    public PortImpl() {
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().Port(this);
        this.mMakeDefault();
    }
