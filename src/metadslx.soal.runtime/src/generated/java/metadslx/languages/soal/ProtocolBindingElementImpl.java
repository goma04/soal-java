...
class ProtocolBindingElementImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.ProtocolBindingElement {
    static {
    ...
    public ProtocolBindingElementImpl() {
        metadslx.languages.soal.SoalImplementationProvider.implementation().ProtocolBindingElement(this);
        this.mMakeDefault();
    }
