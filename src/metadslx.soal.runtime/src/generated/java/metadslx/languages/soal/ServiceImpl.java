...
class ServiceImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Service {
    static {
    ...
    public ServiceImpl() {
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().Service(this);
        this.mMakeDefault();
    }
