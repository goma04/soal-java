...
class ComponentImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Component {
    static {
    ...
    public ComponentImpl() {
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().Component(this);
        this.mMakeDefault();
    }
