...
class LanguageImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Language {
    static {
    ...
    public LanguageImpl() {
        metadslx.languages.soal.SoalImplementationProvider.implementation().Language(this);
        this.mMakeDefault();
    }
