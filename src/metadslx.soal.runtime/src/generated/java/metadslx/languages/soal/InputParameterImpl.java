...
class InputParameterImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.InputParameter {
    static {
    ...
    public InputParameterImpl() {
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().InputParameter(this);
        this.mMakeDefault();
    }
