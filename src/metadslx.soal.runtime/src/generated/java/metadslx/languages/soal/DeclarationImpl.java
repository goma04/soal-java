...
class DeclarationImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Declaration {
    static {
    ...
    public DeclarationImpl() {
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().Declaration(this);
        this.mMakeDefault();
    }
