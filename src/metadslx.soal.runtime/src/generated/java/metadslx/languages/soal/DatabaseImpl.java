...
class DatabaseImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Database {
    static {
    ...
    public DatabaseImpl() {
        this.mSet(metadslx.languages.soal.SoalDescriptor.Database.EntitiesProperty, new metadslx.core.ModelList<Struct>(this, metadslx.languages.soal.SoalDescriptor.Database.EntitiesProperty));
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().Database(this);
        this.mMakeDefault();
    }
    
    public java.util.List<metadslx.languages.soal.Struct> getEntities() {
        Object result = this.mGet(metadslx.languages.soal.SoalDescriptor.Database.EntitiesProperty); 
