...
class ImplementationImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Implementation {
    static {
    ...
    public ImplementationImpl() {
        metadslx.languages.soal.SoalImplementationProvider.implementation().Implementation(this);
        this.mMakeDefault();
    }
