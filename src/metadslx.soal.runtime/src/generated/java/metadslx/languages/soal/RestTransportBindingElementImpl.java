...
class RestTransportBindingElementImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.RestTransportBindingElement {
    static {
    ...
    public RestTransportBindingElementImpl() {
        metadslx.languages.soal.SoalImplementationProvider.implementation().RestTransportBindingElement(this);
        this.mMakeDefault();
    }
