...
class AssemblyImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.Assembly {
    static {
    ...
    public AssemblyImpl() {
        ...
        metadslx.languages.soal.SoalImplementationProvider.implementation().Assembly(this);
        this.mMakeDefault();
    }
