...
class JsonEncodingBindingElementImpl extends metadslx.core.ModelObject implements metadslx.languages.soal.JsonEncodingBindingElement {
    static {
    ...
    public JsonEncodingBindingElementImpl() {
        metadslx.languages.soal.SoalImplementationProvider.implementation().JsonEncodingBindingElement(this);
        this.mMakeDefault();
    }
